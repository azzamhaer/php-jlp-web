...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'kuliner'";
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/kuliner.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Kuliner</h1>
                <p>Temukan berbagai kuliner menarik disini!</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari kuliner enak..." autocomplete="off">
            </div>
        </div>
