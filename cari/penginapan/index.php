...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'penginapan'";
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/penginapan.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Penginapan</h1>
                <p>Cari dimana Anda ingin bermalam</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari hotel, villa atau homestay..." autocomplete="off">
            </div>
        </div>
