...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'wisata_pantai'";
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/pantai.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Wisata Pantai</h1>
                <p>Jelajahi pantai yang cocok untuk bersantai</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari pantai terkenal..." autocomplete="off">
            </div>
        </div>
