...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'event_festival'";
...
<head>
    ...
    <title>Event & Festival - JLP</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/event.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Event & Festival</h1>
                <p>Temukan event dan festival menarik!</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari event, acara, atau festival..." autocomplete="off">
            </div>
        </div>
