...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'pusat_belanja'";
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/shopping.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Pusat Belanja</h1>
                <p>Ingin shopping-shopping? Cari disini!</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari mall, plaza, atau toko..." autocomplete="off">
            </div>
        </div>
