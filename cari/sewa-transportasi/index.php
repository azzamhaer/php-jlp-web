...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'sewa_transportasi'";
...
<head>
    ...
    <title>Sewa Transportasi - JLP</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/transport.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Sewa Transportasi</h1>
                <p>Temukan penyewaan transportasi yang cocok untuk Anda</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari penyewaan motor, mobil, atau minibus..." autocomplete="off">
            </div>
        </div>
