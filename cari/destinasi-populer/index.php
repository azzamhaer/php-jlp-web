...
$query = "SELECT id, profile_picture, main_image, merchant_name, operation_hours, description FROM merchants WHERE tujuan = 'destinasi_populer'";
...
<head>
    ...
    <title>Destinasi Populer - JLP</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <img src="../../assets/images/menu-images/destinasi.webp" alt="Tugu Jogja" class="header-image">
            <div class="header-content">
                <h1>Destinasi Populer</h1>
                <p>Cari tujuan wisata yang populer di Jogja</p>
            </div>
        </div>
        ...
        <div class="search-filter sticky" id="searchFilter">
            <div class="search-bar">
                <input type="text" id="searchInput" name="search_keyword" placeholder="Cari destinasi..." autocomplete="off">
            </div>
        </div>
